...
bool C_Mouse::ButtonDownTick(int iWhich) {
    switch (iWhich) {
        case SDL_BUTTON_LEFT: return bLeftDownTick;
        case SDL_BUTTON_MIDDLE: return bMiddleDownTick;
        case SDL_BUTTON_RIGHT: return bRightDownTick;
...
void C_Mouse::SetDownTick(int iWhich, bool set) {
    switch (iWhich) {
        case SDL_BUTTON_LEFT: bLeftDownTick = set; return;
        case SDL_BUTTON_MIDDLE: bMiddleDownTick = set; return;
        case SDL_BUTTON_RIGHT: bRightDownTick = set; return;
        default: break;
    }
}
bool C_Mouse::LeftClick() { return Click(SDL_BUTTON_LEFT); }
bool C_Mouse::MiddleClick() { return Click(SDL_BUTTON_MIDDLE); }
bool C_Mouse::RightClick() { return Click(SDL_BUTTON_RIGHT); }
...
void C_Mouse::SetButtonDown(int iWhich, bool set) {
    switch (iWhich) {
        case SDL_BUTTON_LEFT: bLeftDown = set;
        case SDL_BUTTON_RIGHT: bRightDown = set;
        case SDL_BUTTON_MIDDLE: bMiddleDown = set;
        default: return;
    }
}
...
bool C_Mouse::In(int x1, int y1, int x2, int y2) {
    if ((InX(x1, x2)) && (InY(y1, y2))) return true;
    return false;
}
bool C_Mouse::InRect(RECT rc) { return (In(rc.left, rc.top, rc.left + rc.right, rc.top + rc.bottom)); }
...
bool C_Mouse::InPct(float fx1, float fy1, float fx2, float fy2) {
    if ((InXPct(fx1, fx2)) && (InYPct(fy1, fy2))) return true;
    return false;
}
void C_Mouse::SetWheelUp(bool m) { bWheelUp = m; }
