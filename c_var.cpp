...
void CVarSet::get_cvar(const char *name, char *value) {
    ...
    strcpy(value, "NULL");
    switch (ivartype) {
        case CVAR_BOOL: strcpy(value, va(get_cvarformat(ivartype), (*(bool *)varmap.find(name)->second))); break;
        case CVAR_INT: strcpy(value, va(get_cvarformat(ivartype), (*(int *)varmap.find(name)->second))); break;
        case CVAR_UINT: strcpy(value, va(get_cvarformat(ivartype), (*(unsigned int *)varmap.find(name)->second))); break;
        case CVAR_CHAR: strcpy(value, va(get_cvarformat(ivartype), (*(char *)varmap.find(name)->second))); break;
        case CVAR_UCHAR: strcpy(value, va(get_cvarformat(ivartype), (*(unsigned char *)varmap.find(name)->second))); break;
        case CVAR_FLOAT: strcpy(value, va(get_cvarformat(ivartype), (*(float *)varmap.find(name)->second))); break;
        case CVAR_LONG: strcpy(value, va(get_cvarformat(ivartype), (*(long *)varmap.find(name)->second))); break;
        case CVAR_ULONG: strcpy(value, va(get_cvarformat(ivartype), (*(unsigned long *)varmap.find(name)->second))); break;
        case CVAR_STRING: strcpy(value, va(get_cvarformat(ivartype), (char *)(varmap.find(name)->second))); break;
        default: strcpy(value, "UNKNOWN"); break;
    }
}
