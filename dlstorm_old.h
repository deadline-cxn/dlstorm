...
Read_line_24_of_dlcs.h

    Deliberate syntax error... You have to define what type of application.

    Current application types _DLCS_CONSOLE OR _DLCS_SDL

                                               Additionally,
    you must define the following _DLCS_OPENGL _DLCS_DEVIL
#endif  // DEFINE TEST
