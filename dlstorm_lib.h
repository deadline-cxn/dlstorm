...
/**********************************************
    ...
    GNU/kFreeBSD / one of the Debian distros that is based on the FreeBSD kernel rather than the Linux or Hurd kernels.
    ...
    Linux kernel / Systems based on the Linux kernel define these macros. There are two major Linux-based operating systems: GNU/Linux and Android, and numerous others like Ångström or OpenEmbedded
    ...
    Microware OS-9
            ...
            __OS9000	Defined by Ultimate C/C++
            _OSK	Defined by Ultimate C/C++
    ...
    Palm OS
            ...
            __palmos__	Defined by GNU C in PRC-Tools
    ...
    SCO OpenServer
            ...
            M_I386	Defined by GNU C
            M_XENIX	Defined by GNU C
            _SCO_DS
    ...
    Windows
            ...
            _WIN16	Defined for 16-bit environments 1
...
/*
    ...
    Windows CE
            ...
            _WIN32_WCE		Defined by Embedded Visual Studio C++
